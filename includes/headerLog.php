...
<?php 
	...
	$query = "SELECT u_fname, u_category FROM `users_details` WHERE u_id = '".$_SESSION["c_id"]."'";
	//query execute
		...
		<nav class="navbar navbar-expand-lg navbar-light navbar-dark bg-dark">
	      ...
	      <div class="collapse navbar-collapse" id="navbarSupportedContent">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item active">
	          	<!-- Profile Menu Button -->
	            <a class="nav-link" href="customer.php"><i class="fa fa-user-circle"></i> Hi. ! <?= $row['u_fname'] ?> <span class="sr-only">(current)</span></a>
	          </li>
	        </ul>
